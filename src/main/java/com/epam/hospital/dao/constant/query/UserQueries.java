...
public class UserQueries {
    public static final String GET_USER_BY_ID = "SELECT * FROM users u WHERE u.id=?";
    public static final String GET_USER_BY_EMAIL = "SELECT * FROM users u WHERE u.email=?";
